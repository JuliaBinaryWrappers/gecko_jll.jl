# `gecko_jll.jl` (v1.0.1+0)

[![deps](https://juliahub.com/docs/gecko_jll/deps.svg)](https://juliahub.com/ui/Packages/General/gecko_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/7f7324cc982fcf663c74f9cd153d086dee7e0213/G/gecko/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* files in directory, relative to originating `build_tarballs.jl`: [`./bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/7f7324cc982fcf663c74f9cd153d086dee7e0213/G/gecko/bundled)
...
The following JLL packages are required by `gecko_jll.jl`:
...
* `LibraryProduct`: `libgeckowrapper`
